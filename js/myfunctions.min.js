...
function countdown(){
    ...
    else
    {
        ...
        document.getElementById("bt_cancel_mail").innerHTML="Die Benachrichtigung wurde abgebrochen.";
    }
} ;
    ...
    try
    {
        ...
        h_receipient = add_receipient(h_receipient, "tb_receipient5");
            $.ajax({
                ...
                dataType: 'jsonp',
                data: { tb_message : document.getElementById("tb_message").value, receipient : h_receipient, key : ""},
                crossDomain: true,
