...
function uuid_success(uuid)
{
    ...
    var h_info = '';
    h_info += 'ID='+g_uuid;
    $("#dyn_info_id").html(h_info).trigger('create');  
    
    checkConnection(); 

    var h_info = '';
    h_info += 'Connection='+g_status_connection;
    $("#dyn_info_connection").html(h_info).trigger('create');  
...
function check_settings(){
    ...
    if(retval == 1)
    {
       alert("Bitte nehmen Sie die Einstellungen vor. Mindestens 'Eigene Mail', 'Mail-Emfänger' und 'Nachricht'");
    }
...
function save_options(){
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            {
               alert("Ihnen wurde eine Aktivierungsmail zugesendet. Bitte rufen Sie den Aktivierungslink auf um Ihre Mailadresse zu aktivieren");
            }
            else
            {
