...
function set_description(){
    var h_description = '';
    h_description += '<p>Die Nachricht <u><i>'+document.getElementById("tb_message").value+'</u></i> wird an folgende Mail-Empänger versendet:</p>';
    ...
    try
    {
        ...
        h_receipient = add_receipient(h_receipient, "tb_receipient5");
            $.ajax({
                ...
                dataType: 'jsonp',
                data: { tb_message : document.getElementById("tb_message").value, receipient : h_receipient, key : "fCPXkFQagMTJNyk9qUza3KnZLeTEBR"},
                crossDomain: true,
