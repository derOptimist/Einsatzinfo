...
function set_description(){
    var h_description_prefix = '';
    var h_description_middle = '';
    var h_description_suffix = '';
    h_description_prefix += '<p>Die Nachricht <br><u><i>'
    h_description_middle = document.getElementById("tb_message").value.replace(/\n/g, '<br />');
    h_description_suffix += '</u></i><br> wird an folgende Mail-Empänger versendet:</p>';
    h_description_suffix += '<p>'+document.getElementById("tb_receipient1").value+'</p>';
    h_description_suffix += '<p>'+document.getElementById("tb_receipient2").value+'</p>';
    h_description_suffix += '<p>'+document.getElementById("tb_receipient3").value+'</p>';
    h_description_suffix += '<p>'+document.getElementById("tb_receipient4").value+'</p>';
    h_description_suffix += '<p>'+document.getElementById("tb_receipient5").value+'</p>';
        
    $("#description").html(h_description_prefix+h_description_middle+h_description_suffix).trigger('create');  
