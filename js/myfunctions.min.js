   ...
   $.ajax({
      ...
      success: function(res) {
         ...
         else if(res.activated == "false")
         {
            ...
            document.getElementById('lb_counter').innerHTML="Ihnen wurde eine Aktivierungsmail zugesendet. Bitte rufen Sie den Aktivierungslink in der Ihnen zugesendeten Mail auf um Ihre Mailadresse zu aktivieren.";
            //Direkt die Optionen anzeigen
            location.href=("#Options");
            //Abbruch der Initialisierung
            g_status_mail = "inactive";
            
            show_message("Ihnen wurde eine Aktivierungsmail zugesendet. Bitte rufen Sie den Aktivierungslink in der Ihnen zugesendeten Mail auf um Ihre Mailadresse zu aktivieren.");
         }
         else
         {
