...
alert("onDeviceReady");
window.plugins.uniqueDeviceID.get(uuid_success, fail);
...
function set_buttontext(img, text){
   ...
   h_html += '<td><font size="6"><center>'+text+'</center></font></td>';
   h_html += '<td><img src="images/'+img+'" width="48" height="48"></td>';
   h_html += '</tr>';
   h_html += '<table></center>';
