...
var url_send_mail = 'https://www.schwitte.de/einsatzinfo/send_mail.php';
var url_save_options = 'https://www.schwitte.de/einsatzinfo/save_options.php';
var url_get_infos = 'https://www.schwitte.de/einsatzinfo/get_infos.php';
   ...
   $.ajax({
      ...
      success: function(res) {
         ...
         if(check_settings("load") == 0)
         {
            ...
            h_description += '</u></i><br> wird an folgenden Mail-Empfänger versendet:</p>';
            h_description += '<ul>';
         ...
         else
         {
            ...
            navigator.notification.confirm(
                'Hiermit stimme ich den Datenschutzbestimmungen zu.', // message
                 show_datenschutz,            // callback to invoke with index of button pressed
                'Datenschutzbestimmungen',    // title
                ['Anzeigen','Zustimmen']     // buttonLabels
            );
         ...
         else if(res.activated == "false")
         {
            ...
            document.getElementById('lb_counter').innerHTML="Ihnen wurde eine Aktivierungsmail zugesendet. Bitte rufen Sie den Aktivierungslink in dieser Mail auf um Ihre Mailadresse zu aktivieren.";
            //Direkt die Optionen anzeigen
            location.href=("#Options");
            //Abbruch der Initialisierung
            g_status_mail = "inactive";
            
            show_message("Ihnen wurde eine Aktivierungsmail zugesendet. Bitte rufen Sie den Aktivierungslink in dieser Mail auf um Ihre Mailadresse zu aktivieren.");
         }
         else
         {
...
function send_email(){
   ...
   $.ajax({
      ...
      dataType: 'jsonp',
      async: false, 
      data: { tb_message : document.getElementById("tb_message").value.replace(/\n/g, '<br />'), receipient : h_receipient, tb_mail : document.getElementById("tb_mail").value, uuid : g_uuid, key : h_secretkey },
      crossDomain: true,
      success: function(res) {
         console.log(res);
...
function show_datenschutz(buttonIndex){
    if(buttonIndex == 1)
    {
        window.location.replace("https://www.schwitte.de/einsatzinfo/datenschutz/");
    }
}