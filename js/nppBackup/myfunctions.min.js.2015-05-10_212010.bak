...
$(document).ready(function(){
   if(check_settings() == 1)
   {
       alert("Bitte nehmen Sie die Einstellungen vor.");
...
function check_settings(){
    if(document.getElementById("tb_receipient1").value == "" && _
    if document.getElementById("tb_receipient2").value == "" && _
    if document.getElementById("tb_receipient3").value == "" && _
