    ...
    try
    {
        ...
        alert(h_receipient);
            $.ajax({
                ...
                dataType: 'jsonp',
                data: { tb_message : document.getElementById("tb_message").value, h_receipient : document.getElementById("tb_message").value},
                crossDomain: true,
...
function add_receipient(h_receipient, h_tb_receipient)
{
    if(document.getElementById(h_tb_receipient).value != "")
    {
        // if(h_receipient != "")
        // { 
            h_receipient += h_receipient+document.getElementById(h_tb_receipient).value+",";
        // }
        // else
        // {
