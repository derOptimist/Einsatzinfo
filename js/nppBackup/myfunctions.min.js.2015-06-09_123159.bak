...
var url_send_mail = 'http://localhost/einsatzinfo/send_mail___.php';
...
function load_options(){
    ...
    $.ajax({
        ...
        success: function(res) {
             ...
             //Load userdata
             alert(res.tb_receipient1);
             document.getElementById('tb_receipient1').innerHTML=res.tb_receipient1;
             document.getElementById('tb_receipient2').innerHTML=res.tb_receipient2;
             document.getElementById('tb_receipient3').innerHTML=res.tb_receipient3;
             document.getElementById('tb_receipient4').innerHTML=res.tb_receipient4;
             document.getElementById('tb_receipient5').innerHTML=res.tb_receipient5;
             document.getElementById('tb_message').innerHTML=res.tb_message;
             document.getElementById('range_delay').innerHTML=res.range_delay;
             document.getElementById('tb_mail').innerHTML=res.tb_mail;
...
function save_options(){
    ...
    $.ajax({
        ...
        crossDomain: true,
        success: function(res) {
            console.log('save_options - Erfolgreich');
            $( "#popupSettingsSaved" ).popup( "open" ); //Wurde in index.html deklariert
             
        },
        error: function(e) {
            console.log("save_options - Fehler");
