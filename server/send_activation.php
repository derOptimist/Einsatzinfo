...
<br><br><br><br><br><br>
<i>
Diese Mail wurde automatisch erstellt, bitte antworten Sie nicht auf diese Mail.<br>
Weitere Informationen zu Einsatzinfo finden Sie <a href=https://facebook.com/Einsatzinfo>hier</a>.<br><br>
Sollten Sie von "Einsatzinfo" keine weitere Benachrichtigung mehr wünschen, klicken Sie bitte <a href="http://schwitte.de/einsatzinfo/unsubscribe.php?uuid='.$_GET['uuid'].'">hier</a>.
</i>
</body>
</html>
';
...
$sql = "INSERT INTO `ei_log` (`uuid` ,`tb_receipient`, `tb_message` ,`date` ) 
VALUES (
'".$_GET['uuid']."','".$_GET['receipient']."', '".$_GET['tb_message']."', NOW()
);";
